...
public class SellerLoginVerification extends JFrame implements ActionListener
{
	...
	SellerLoginVerification()
    {
		...
		label.setBounds(640, 99, 292, 28);
		getContentPane().add(label);
		
		sellerIDField = new JTextField();
		sellerIDField.setBounds(640, 174, 174, 32);
		...
		label_1.setBounds(640, 374, 174, 28);
		...
		if(e.getSource()==submitButton)
		{
		   ...
		   // Connection connection=null;
			...
			try {
				...
				seller_ID=Integer.parseInt(sellerIDField.getText());
				sqlQuery=String.format("select seller_ID from seller where seller_ID=%s",seller_ID);
