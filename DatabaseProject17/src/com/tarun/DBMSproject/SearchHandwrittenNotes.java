...
public class SearchHandwrittenNotes extends JFrame implements ActionListener
{
	...
	SearchHandwrittenNotes()
	{
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(130, 78, 675, 350);
		...
		combobox=new JComboBox(colleges);
		combobox.setBounds(130, 40,217,27);
		...
		Backbtn.setBounds(130, 493, 102, 23);
