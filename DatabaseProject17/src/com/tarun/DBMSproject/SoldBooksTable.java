...
public class SoldBooksTable extends JFrame implements ActionListener
{
	JTable table;
	JButton HomeButton;
	String sqlQuery="";
	SoldBooksTable()
	{
		...
		scrollPane.setBounds(388, 71, 814, 456);
		...
		try {
			...
			ResultSet rs;
			sqlQuery=String.format("Select Book_ID,Authour,Semester,Price,status from booksna;");
		...
		HomeButton.setBounds(801, 650, 89, 23);
